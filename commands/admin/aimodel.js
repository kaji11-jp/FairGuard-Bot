...
const ALL_MODELS = [
  // --- Google Gemini ---
  {
    label: "Gemini 3.1 Pro (最高性能)",
    value: "gemini:gemini-3.1-pro-preview",
    description: "Googleの最新・最高性能モデル（プレビュー）",
    emoji: "🌟",
  },
  {
    label: "Gemini 3.1 Flash",
    value: "gemini:gemini-3.1-flash",
    description: "高速・高性能のバランス型モデル",
    emoji: "⚡",
  },
  {
    label: "Gemini 3.1 Flash Lite",
    value: "gemini:gemini-3.1-flash-lite-preview",
    description: "最速・低コスト、高ボリューム向け",
    emoji: "💨",
  },
  {
    label: "Gemini 2.5 Flash (安定版)",
    value: "gemini:gemini-2.5-flash",
    description: "安定稼働中・本番利用向けコスパモデル",
    emoji: "🚀",
  },
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setFooter({
        text: "Google Cloud, OpenAI, Anthropic, Cerebras等の最新モデルに対応",
      });
    ...
    // コレクターの設定
    const filter = (i) =>
      i.customId === "aimodel_select" && i.user.id === interaction.user.id;
